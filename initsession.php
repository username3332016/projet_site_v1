...
if ($ligne[0] == 0) {
	...
	$idClient = mysqli_insert_id($db);
	mysqli_query($db, "INSERT INTO suivi_progression (utilisateur_id,date,objectif_id,poids, pas, eau, sommeil, energie,calories_mangees,calories_brulees) VALUES ($idClient,'$today','1','$poids', '$pas', '$eau', '$sommeil', '$energie', '$calories_mangees', '$calories_brulees')");
} else {
